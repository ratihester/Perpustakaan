...
<body>
 ...
 <aside>
   ...
   <?php
      ...
      $sql = "SELECT * FROM tbl_anggota, tbl_kelas WHERE tbl_anggota.id_kelas = tbl_kelas.id_kelas";
     ...
     <section id="main-content">
      <section class="wrapper">
        ...
        <div class="row mb">
         ...
         <form method="POST" action="anggota_input.php">
          <button class="btn btn-theme" type="submit" ><i class="fa fa-plus"></i>Data Anggota</button>&nbsp;
          <a href="anggota_import.php" class="btn btn-success">Import Data</a>&nbsp;
         </form>
          </div>
          <!-- page start-->
              ...
              <table cellpadding="0" cellspacing="0" border="0" class="display table table-bordered" id="hidden-table-info">
                ...
                <tr>
                    ...
                    <td>
                       ...
                       <a href="anggota_edit.php?id_anggota=<?php echo $data['id_anggota'];?>"><i class="fa fa-edit"></i>Edit</a>
                      <!--a href="delete_user.php"><i class="fa fa-trash text-danger"></i>Delete</a-->
                      <a href="delete_anggota.php?id_anggota=<?php echo $data['id_anggota'];?>" onclick="return confirm('Yakin mau dihapus?');" <i class="fa fa-trash text-danger"></i>Delete</a>
                    </td>
