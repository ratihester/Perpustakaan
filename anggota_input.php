        ...
        <div class="row mt">
          <div class="col-lg-12">
            ...
            <div class="form-panel">
              <div class="form">
                <form class="cmxform form-horizontal style-form" id="signupForm" method="POST" action="proses-tambahanggota.php">
                  <div class="form-group ">
                    <label for="noinduk" class="control-label col-lg-2">No Induk</label>
                    <div class="col-lg-10">
                      <input class=" form-control" id="noinduk" name="noinduk" type="text" placeholder="Nama Induk" required />
                    </div>
                  </div>
                  <div class="form-group ">
                  ...
                  <div class="form-group ">
                    <label for="tanggallahir" class="control-label col-lg-2">Tanggal Lahir</label>
                    <div class="col-lg-10">
                      <input class="form-control " id="tanggallahir" name="tanggallahir" type="date" placeholder="hh/bb/tttt" />
                    </div>
                  </div>
                  <div class="form-group ">
                    <label for="alamat" class="control-label col-lg-2">Alamat</label>
                    <div class="col-lg-10">
                      <input class="form-control " id="alamat" name="alamat" type="alamat" placeholder="Alamat" required />
                    </div>
                  </div>
                  <div class="form-group ">
                  ...
                  <div class="form-group">
                    <label  for="tahun_ajaran" class="control-label col-lg-2">Tahun  Ajaran</label>
                    <div class="col-lg-10">
                      ...
                      for ($i=2011; $i <= $x ; $i++) { 
                      ?>
                      <option value="<?php echo $i; ?><?php echo "/"; ?><?php echo $i+1; ?>"><?php echo $i; ?><?php echo "/"; ?><?php echo $i+1; ?></option>
                      <?php
                      }
                      ?>
                    </select>
