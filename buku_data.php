...
<body>
    ...
    ?>
     ...
     <section id="main-content">
      <section class="wrapper">
        ...
        <div class="row mb">
          <div>
         <a href="buku_input.php" class="btn btn-theme"><i class="fa fa-plus"></i> Data Buku </a>
          <a href="expor_buku.php" class="btn btn-facebook"><i class="fa fa-ekspor"></i> Ekspor Data Buku </a>
          <!-- <form method="POST" autocomplete="on" action="expor_buku.php" enctype="multipart/form-data" target="formresponse">
          <button type="submit" class="btn btn-facebook" name="cek">Ekspor
          </button>
          </form> -->
            ...
            <div class="adv-table">
              <table cellpadding="0" cellspacing="0" border="0" class="display table table-bordered" id="hidden-table-info">
                ...
                <tr>
                  ...
                  <td>
                      <a href="buku_edit.php?idbuku=<?php echo $idbuku;?>"><i class="fa fa-edit"></i>Edit</a>

                       <!--a href="delete_user.php"><i class="fa fa-trash text-danger"></i>Delete</a-->
                      <a href="delete_buku.php?kode_buku=<?php echo $data['kode_buku'];?>" onclick="return confirm('Yakin mau di hapus?');" <i class="fa fa-trash text-danger"></i>Delete</a>
                    </td>
                 </tr>
                <?php
                $no++;
  ...
  <script type="text/javascript">
    ...
    function fnFormatDetails(oTable, nTr) {
      ...
      sOut += '<tr><td>Judul Buku:</td><td> ' + aData[4] + '</td></tr>';
      sOut += '<tr><td>Kode Buku:</td><td>' + aData[3] + '</td></tr>';
      sOut += '<tr><td>Jenis Buku:</td><td>' + aData[2]+ '</td></tr>';
      sOut += '</table>';
