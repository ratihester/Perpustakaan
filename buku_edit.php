...
<body>
  <section id="container">
   ...
   <!--sidebar start-->
    ...
    $query = mysqli_query($connection, "SELECT * FROM tbl_buku WHERE idbuku=".$idbuku."");
        ...
        <div class="row mt">
          <div class="col-lg-12">
            ...
            <div class="form-panel">
              <div class="form">
                <form class="cmxform form-horizontal style-form" id="edit" method="POST" action="proses-editbuku.php">
                  <div class="form-group ">
                    ...
                    <div class="col-lg-10">
                      <select class="form-control"  name="jenis_buku" required>
                        <option value="paket" <?php if ($jenis_buku=="paket") echo 'selected="selected"';?>>Buku Paket</option>
                        <option value="cerita" <?php if ($jenis_buku=="cerita") echo 'selected="selected"';?>>Buku Cerita</option>  
                    </select>
                    </div>
                  </div>
                  <div class="form-group ">
                    <label for="kode_buku" class="control-label col-lg-2">Kode Buku</label>
                    <div class="col-lg-10">
                      <input class="form-control " id="kode_buku" name="kode_buku" type="text" placeholder="Kode Buku" value="<?php echo $kode_buku; ?>" />
                    </div>
                  </div>
                  <div class="form-group ">
                    <label for="judul_buku" class="control-label col-lg-2">Judul Buku</label>
                    <div class="col-lg-10">
                      <input class="form-control " id="judul_buku" name="judul_buku" type="text" placeholder="Judul Buku" value="<?php echo $judul_buku; ?>" required />
                    </div>
                  </div>
                  <div class="form-group ">
                    <label for="pengarang" class="control-label col-lg-2">Pengarang</label>
                    <div class="col-lg-10">
                      <input class="form-control " id="pengarang" name="pengarang" type="text" placeholder="Pengarang" value="<?php echo $pengarang; ?>" required />
                    </div>
                  </div>
                  <div class="form-group ">
                    <label for="penerbit" class="control-label col-lg-2">Penerbit</label>
                    <div class="col-lg-10">
                      <input class="form-control " id="penerbit" name="penerbit" type="text" placeholder="Pengarang" value="<?php echo $penerbit; ?>" required />
                    </div>
                  </div>

                   <div class="form-group ">
                    <label for="thn_terbit" class="control-label col-lg-2">Tahun Terbit</label>
                    <div class="col-lg-10">
                      <input class="form-control " id="thn_terbit" name="thn_terbit" type="text" placeholder="Tahun Terbit" value="<?php echo $thn_terbit; ?>" required />
                    </div>
                  </div>
              

                 <div class="form-group ">
                    <label for="jumlah_buku" class="control-label col-lg-2">Jumlah Buku</label>
                    <div class="col-lg-10">
                      <input class="form-control " id="jumlah_buku" name="jumlah_buku" type="text" placeholder="Jumlah Buku" value="<?php echo $jumlah_buku; ?>" required />
                    </div>
                  </div>
                   ...
                   <div class="form-group ">
                    ...
                    <div class="col-lg-10">
                      <input class="form-control " id="kurikulum" name="kurikulum" type="text" placeholder="Kurikulum" value="<?php echo $kurikulum; ?>" required />
                    </div>
                  </div>
                  ...
                  <div class="form-group">
                    <div class="col-lg-offset-2 col-lg-10">
                      ...
                      <a href="buku_data.php" class="btn btn-success">Kembali</a>
                    </div>
                  </div>
                </form>
              </div>
