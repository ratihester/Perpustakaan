        ...
        <div class="row mt">
          <div class="col-lg-12">
            ...
            <div class="form-panel">
              <div class="form">
                <form class="cmxform form-horizontal style-form" id="add" method="POST" action="proses-tambahbuku.php">
                  ...
                  <div class="form-group ">
                    ...
                    <div class="col-lg-10">
                      <input class="form-control " id="kode_buku" name="kode_buku" type="text" placeholder="Kode Buku" />
                    </div>
                  </div>
                  <div class="form-group ">
                    <label for="judul_buku" class="control-label col-lg-2">Judul Buku</label>
                    <div class="col-lg-10">
                      <input class="form-control " id="judul_buku" name="judul_buku" type="text" placeholder="Judul Buku" required />
                    </div>
                  </div>
                  <div class="form-group ">
                    <label for="pengarang" class="control-label col-lg-2">Pengarang</label>
                    <div class="col-lg-10">
                      <input class="form-control " id="pengarang" name="pengarang" type="text" placeholder="Pengarang" required />
                    </div>
                  </div>
                  <div class="form-group ">
                    <label for="penerbit" class="control-label col-lg-2">Penerbit</label>
                    <div class="col-lg-10">
                      <input class="form-control " id="penerbit" name="penerbit" type="text" placeholder="Pengarang" required />
                    </div>
                  </div>
                   ...
                   <div class="form-group ">
                    ...
                    <div class="col-lg-10">
                      <input class="form-control " id="thn_terbit" name="thn_terbit" type="text" placeholder="Tahun Terbit" required />
                    </div>
                  </div>
                 ...
                 <div class="form-group ">
                    ...
                    <div class="col-lg-10">
                      <input class="form-control " id="jumlah_buku" name="jumlah_buku" type="text" placeholder="Jumlah Buku" required />
                    </div>
                  </div>
                   ...
                   <div class="form-group ">
                    ...
                    <div class="col-lg-10">
                      <input class="form-control " id="kurikulum" name="kurikulum" type="text" placeholder="Kurikulum" required />
                    </div>
                  </div>
                  ...
                  <div class="form-group">
                      ...
                      <input type="hidden" name="judul_bukubaru" value="<?php echo $_POST['jenis_bukubaru']; ?>">
