...
<body>
    ...
    ?>
     ...
     <section id="main-content">
      <section class="wrapper">
        ...
        <div class="row mb">
          <div>
         <a href="pengunjung_input.php" class="btn btn-theme"><i class="fa fa-plus"></i> Data Tamu</a>
          </div>
          <!-- page start-->
              ...
              <table cellpadding="1" cellspacing="1" border="1" class="display table table-bordered" id="hidden-table-info">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>
                      <a href="pengunjung_edit.php?id_pengunjung=<?php echo $id_pengunjung;?>"><i class="fa fa-edit"></i>Edit</a>

                      <a href="delete_pengunjung.php?id=<?php echo $row['id_pengunjung'];?>" onclick="return confirm('Yakin mau di hapus?');" <i class="fa fa-trash text-danger"></i>Delete</a>
                    </td>
                 </tr>
                <?php
                $no++;
  ...
  <script type="text/javascript">
    ...
    function fnFormatDetails(oTable, nTr) {
      ...
      sOut += '<tr><td>Jenis Kelamin:</td><td>' + aData[3] + '</td></tr>';
