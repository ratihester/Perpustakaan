...
<head>
 ...
 <!-- <link href="lib/font-awesome/css/font-awesome.css" rel="stylesheet" />
  ...
  <!-- font awesome masih link internet -->
  <link rel="stylesheet" href="https://use.fontawesome.com/releases/v5.8.1/css/all.css" integrity="sha384-50oBUHEmvpQ+1lW4y57PTFmhCaXp0ML5d60M1M7uH2+nqUivzIebhndOJK28anvf" crossorigin="anonymous">
  <script src="../lib/chart-master/Chart.js"></script>
  <link rel="stylesheet" type="text/css" href="../lib/head.php">
  <!-- =======================================================
    ...
    ?>
     ...
     <section id="main-content">
      <section class="wrapper">
        <h3>Print Data User</h3>
        <div class="row mb">
          <div style="padding-left: 20px;">
         <a href="cetak_data.php" class="btn btn-success">Kembali</a>
         <a href="print_user.php" class="btn btn-primary"><i class="fa fa-print"></i>Print</a>
          </div>
          <!-- page start-->
          <div class="content-panel" style="padding: 0.75rem;">
            <div class="adv-table">
              <iframe src="cetak_rekap_ratih.php" width="100%" height="500px" frameborder="0"></iframe>
            </div>
            <div class="adv-table">  
              <table cellpadding="1" cellspacing="1" border="1" class="display table table-bordered" id="hidden-table-info table-print">
                <thead>
                  <tr>
                    <th>No</th>
                    <th>Nama</th>
...
<!--  <script src="lib/common-scripts.js"></script>
  ...
  <script type="text/javascript">
    ...
    function fnFormatDetails(oTable, nTr) {
      ...
      sOut += '<tr><td>Username:</td><td>' + aData[3] + '</td></tr>';
