        ...
        <div class="row mt">
          <div class="col-lg-12">
            ...
            <div class="form-panel">
              <div class="form">
                <form class="cmxform form-horizontal style-form" id="tambah" method="POST" action="proses-tambahkelas.php">
                  <div class="form-group ">  
                    <label for="kd_kelas" class="control-label col-lg-2">Kode Kelas</label>
                    <div class="col-lg-10">
                      <input class=" form-control" id="kd_kelas" name="kd_kelas" type="text" placeholder="Kode Kelas" required />
                    </div>
                  </div>
                  <div class="form-group ">
                    <label for="nama_kelas" class="control-label col-lg-2">Nama Kelas</label>
                    <div class="col-lg-10">
                      <input class="form-control " id="nama_kelas" name="nama_kelas" type="text" placeholder=" Nama Kelas" required />
                    </div>
                  </div>
                  <div class="form-group">
                    <div class="col-lg-offset-2 col-lg-10">
                      <button class="btn btn-theme" type="submit" name="tambah">Simpan</button>
                      <a href="kelas_data.php" class="btn btn-success">Kembali</a>
