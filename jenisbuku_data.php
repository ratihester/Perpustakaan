    ...
    ?>
     ...
     <section id="main-content">
      <section class="wrapper">
        ...
        <div class="row mb">
          <div>
         <a href="jenisbuku_input.php" class="btn btn-theme"><i class="fa fa-plus"></i> Data Jenis Buku</a>
          </div>
          <!-- page start-->
            ...
            <div class="adv-table">
              <table cellpadding="1" cellspacing="1" border="1" class="display table table-bordered" id="hidden-table-info">
                ...
                <tbody>
                  ...
                  <tr>
                    <td><?php echo $no; ?></td>
                    <td><?php echo $row['nama_jenis_buku']; ?></td>
                    <td>
                      <a href="jenisbuku_edit.php?id=<?php echo $id;?>"><i class="fa fa-edit"></i>Edit</a>
                      <!--a href="delete_user.php"><i class="fa fa-trash text-danger"></i>Delete</a-->
                      <a href="delete_jenisbuku.php?id=<?php echo $row['id'];?>" onclick="return confirm('Yakin mau di hapus?');" <i class="fa fa-trash text-danger"></i>Delete</a>
                    </td>
                 </tr>
                <?php
                $no++;
