        ...
        <div class="row mt">
          <div class="col-lg-12">
            ...
            <div class="form-panel">
              <div class="form">
                <form class="cmxform form-horizontal style-form" id="tambah" method="POST" action="proses-tambahjenisbuku.php">
                  <div class="form-group ">  
                    <label for="firstname" class="control-label col-lg-2">Jenis Buku</label>
                    <div class="col-lg-10">
                      <input class=" form-control" id="tbl_jenis_buku" name="tbl_jenis_buku" type="text" placeholder="Jenis Buku" required />
                    </div>
                  </div>
                  <div class="form-group">
                    <div class="col-lg-offset-2 col-lg-10">
                      <button class="btn btn-theme" type="submit" name="tambah">Simpan</button>
                      <a href="jenisbuku_data.php" class="btn btn-success">Kembali</a>
