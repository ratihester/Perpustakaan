...
<body>
    ...
    ?>
     ...
     <section id="main-content">
      <section class="wrapper">
        ...
        <div class="row mb">
          <div>
         <a href="input_kelas.php" class="btn btn-theme"><i class="fa fa-plus"></i> Kategori Kelas</a>
          </div>
          <!-- page start-->
              ...
              <table cellpadding="1" cellspacing="1" border="1" class="display table table-bordered" id="hidden-table-info">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>
                      <a href="kelas_edit.php?id_kelas=<?php echo $id_kelas;?>"><i class="fa fa-edit"></i>Edit</a>
                      <!--a href="delete_user.php"><i class="fa fa-trash text-danger"></i>Delete</a-->
                      <a href="delete_kelas.php?id=<?php echo $row['id_kelas'];?>" onclick="return confirm('Yakin mau di hapus?');" <i class="fa fa-trash text-danger"></i>Delete</a>
                    </td>
                 </tr>
                <?php
                $no++;
  ...
  <script type="text/javascript">
    ...
    function fnFormatDetails(oTable, nTr) {
      ...
      sOut += '<tr><td>Nama Kelas:</td><td> ' + aData[3] + '</td></tr>';
      sOut += '<tr><td>Kode Kelas:</td><td>' + aData[2] + '</td></tr>';
      sOut += '</table>';
