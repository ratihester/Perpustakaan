        ...
        <div class="row mt">
          <div class="col-lg-12">
            ...
            <div class="form-panel">
              <div class="form">
                <form class="cmxform form-horizontal style-form" id="add" method="POST" action="proses-tambahpeminjaman.php">
                  ...
                  <div class="form-group ">
                    ...
                    <div class="col-lg-10">
                      <input class="form-control " id="tgl_kembali" name="tgl_kembali" type="text" placeholder="tanggal kembali" value="<?php echo date('d-m-Y', strtotime("+7 days")); ?>" required />
                    </div>
                  </div>
                  ...
                  <div class="form-group">
                    <div class="col-lg-offset-2 col-lg-10">
                      ...
                      <a href="data_peminjaman.php" class="btn btn-success">Kembali</a>
                    </div>
                  </div>
                </form>
              </div>
