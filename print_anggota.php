...
<body>
  <section id="container">
   ...
   <?php
      ...
      $sql = "SELECT * FROM tbl_anggota, nama_kelas.tbl_kelas WHERE tbl_anggota.id_kelas = tbl_kelas.id_kelas";
      ...
      <section class="wrapper">
        <div class="row mb">
          ...
          <div class="content-panel" style="padding: 0.75rem;">
            <form method="POST" autocomplete="on" action="cetak_rekap_anggota.php" enctype="multipart/form-data" target='printf'>
             <table>
               <tr>
                 <td>Tahun Ajaran</td>
                <td>:</td>
               ...
               <tr>
                 <td colspan="3"><input class="btn btn-success form-control p-3" type="submit" value="Tampilkan"></td>
               </tr>
             </table>
           </form>
         </div>

          <div class="content-panel" style="padding: 0.75rem;" style="display: none;">



            <div class="adv-table">
              <iframe id="printf" name="printf" width="100%" height="500px" frameborder="0"></iframe>
            </div>
