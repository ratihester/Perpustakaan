  ...
  <section id="container">
   ...
   <aside>
    ...
    <?php
      ...
      $sql = "SELECT * FROM `tbl_peminjaman` JOIN `tbl_anggota` ON `tbl_peminjaman`.`id_anggota` = `tbl_anggota`.`id_anggota` JOIN `tbl_buku` ON `tbl_buku`.`idbuku` = `tbl_peminjaman`.`idbuku` JOIN `tbl_kelas` ON `tbl_anggota`.`id_kelas` = `tbl_kelas`.`id_kelas`";
      ...
      <section class="wrapper">
        <div class="row mb">
          ...
          <div class="content-panel" style="padding: 0.75rem;">
            <div class="adv-table">
              <iframe id="printf" name="printf" src="cetak_rekap_peminjamanm.php" width="100%" height="500px" frameborder="0"></iframe>
            </div>
