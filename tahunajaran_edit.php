...
<body>
  <section id="container">
   ...
   <!--sidebar start-->
    ...
    $query = mysqli_query($connection, "SELECT * FROM tbl_tahun_ajaran WHERE id=".$id."");
        ...
        <div class="row mt">
          <div class="col-lg-12">
            ...
            <div class="form-panel">
              <div class="form">
                <form class="cmxform form-horizontal style-form" id="edit" method="POST" action="proses-edittahunajaran.php">
                  <div class="form-group ">
                    <input type="hidden" name="id" value="<?php echo $id; ?>">
                    <label for="firstname" class="control-label col-lg-2">Tahun Ajaran</label>
                    <div class="col-lg-10">
                      <input class=" form-control" id="firstname" name="tahunajaran" type="text" placeholder="" value="<?php echo $tahunajaran; ?>" />
                    </div>
                  </div>
                  <div class="form-group">
                    <div class="col-lg-offset-2 col-lg-10">
                      <button class="btn btn-theme" type="submit" name="edit">Simpan</button>
                      <a href="tahunajaran_data.php" class="btn btn-success">Batal</a>
                    </div>
                  </div>
                </form>
              </div>
