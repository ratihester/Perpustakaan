        ...
        <div class="row mt">
          <div class="col-lg-12">
            ...
            <div class="form-panel">
              <div class="form">
                <form class="cmxform form-horizontal style-form" id="tambah" method="POST" action="proses-tambahtahunajaran.php">
                  <div class="form-group ">  
                    <label for="firstname" class="control-label col-lg-2">Tahun Ajaran</label>
                    <div class="col-lg-10">
                      <input class=" form-control" id="tahunajaran" name="tahunajaran" type="text" placeholder="Tahun Ajaran" required />
                    </div>
                  </div>
                  <div class="form-group">
                    <div class="col-lg-offset-2 col-lg-10">
                      <button class="btn btn-theme" type="submit" name="tambah">Simpan</button>
                      <a href="tahunajaran_data.php" class="btn btn-success">Kembali</a>
