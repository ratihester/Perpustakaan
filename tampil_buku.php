...
<body>
  <section id="container">
   ...
   <?php
      ...
      $buku = $_GET['jenis_buku'];
      $sql = "SELECT * FROM `tbl_buku` WHERE jenis_buku='$buku' ";
     ...
     <section id="main-content">
      <section class="wrapper">
        ...
        <div class="row mb">
         ...
         <a href="buku_input.php" class="btn btn-theme"><i class="fa fa-plus"></i> Data Buku <?php echo strtoupper($buku); ?></a>
          </div>
          <!-- page start-->
            ...
            <div class="adv-table">
              <table cellpadding="0" cellspacing="0" border="0" class="display table table-bordered" id="hidden-table-info">
                ...
                <tr>
                  ...
                  <td>
                      <a href="buku_edit.php"><i class="fa fa-edit"></i>Edit</a>
