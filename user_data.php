    ...
    ?>
     ...
     <section id="main-content">
      <section class="wrapper">
        ...
        <div class="row mb">
          <div>
         <a href="user_input.php" class="btn btn-theme"><i class="fa fa-plus"></i> Data User</a>
          </div>
          <!-- page start-->
              ...
              <table cellpadding="1" cellspacing="1" border="1" class="display table table-bordered" id="hidden-table-info">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>
                      <a href="user_edit.php?id=<?php echo $id_user;?>"><i class="fa fa-edit"></i>Edit</a>
                      <!--a href="delete_user.php"><i class="fa fa-trash text-danger"></i>Delete</a-->
                      <a href="delete_user.php?id=<?php echo $row['id_user'];?>" onclick="return confirm('Yakin mau di hapus?');" <i class="fa fa-trash text-danger"></i>Delete</a>
                    </td>
                 </tr>
                <?php
                $no++;
