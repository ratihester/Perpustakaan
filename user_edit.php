        ...
        <div class="row mt">
          <div class="col-lg-12">
            ...
            <div class="form-panel">
              <div class="form">
                <form class="cmxform form-horizontal style-form" id="edit" method="POST" action="proses-edituser.php">
                  <div class="form-group ">
                    <input type="hidden" name="id_user" value="<?php echo $id_user; ?>">
                    <label for="firstname" class="control-label col-lg-2">Nama</label>
                    <div class="col-lg-10">
                      <input class=" form-control" id="firstname" name="nama" type="text" placeholder="Nama Lengkap" value="<?php echo $nama; ?>" />
                    </div>
                  </div>
                  <div class="form-group ">
                  ...
                  <div class="form-group ">
                    ...
                    <div class="col-lg-10">
                      <input class="form-control " id="confirm_password" name="confirm_password" type="password" placeholder=" Confirm.." value="<?php echo $password; ?>" required />
                    </div>
                  </div>
                  <div class="form-group ">
                  ...
                  <div class="form-group">
                    <div class="col-lg-offset-2 col-lg-10">
                      ...
                      <a href="user_data.php" class="btn btn-success">Batal</a>
                    </div>
                  </div>
                </form>
              </div>
