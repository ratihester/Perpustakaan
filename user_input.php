        ...
        <div class="row mt">
          <div class="col-lg-12">
            ...
            <div class="form-panel">
              <div class="form">
                <form class="cmxform form-horizontal style-form" id="tambah" method="POST" action="proses-tambahuser.php">
                  ...
                  <div class="form-group ">
                    ...
                    <div class="col-lg-10">
                      <input class="form-control " id="confirm_password" name="confirm_password" type="password" placeholder=" Confirm.." required />
                    </div>
                  </div>
                  <div class="form-group ">
                  ...
                  <div class="form-group">
                    <div class="col-lg-offset-2 col-lg-10">
                      ...
                      <a href="user_data.php" class="btn btn-success">Kembali</a>
